...
If an Ivy component's dependency was substituted for a project dependency, configurations in that project could be selected that were marked as non-consumable.
