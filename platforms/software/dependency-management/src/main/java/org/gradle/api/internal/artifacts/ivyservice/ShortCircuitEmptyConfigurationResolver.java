...
public class ShortCircuitEmptyConfigurationResolver implements ConfigurationResolver {
    ...
    private VisitedGraphResults emptyGraphResults(ResolveContext resolveContext) {
        ...
        MinimalResolutionResult emptyResult = ResolutionResultGraphBuilder.empty(id, componentIdentifier, resolveContext.getAttributes().asImmutable(), resolveContext.getName(), attributeDesugaring);
